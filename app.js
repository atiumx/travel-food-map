...
(() => {
  ...
  // - 📨 推薦地點 (friend+owner): submit URL + rating + comment
  // - 🆕 最近朋友推薦 (all incl. guest): list approved submissions for current trip_area
  // - 🌟 最近推薦 (owner only): list_pending_submissions → resolve → approve/reject
  // - OpenRice manual_fill_required: owner 手動填 name/coords/address
  // - 嵌入式 debug pane + MutationObserver 監察 modal 開合
  // =============================================================
  const FeatureB = (() => {
    ...
    return { init, refreshDebugPane };
  })();

  // ============================================================
  // v1.0.66 Feature C: 邀請碼管理 (owner only)
  // ============================================================
  const FeatureC = (function(){
  ...
  // Wire FeatureC after appDialog ready
