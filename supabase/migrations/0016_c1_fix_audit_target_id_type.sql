-- Fix audit target_id column type: was text-cast, now uuid
...
begin
  ...
  values ('add_place_photo', 'place_photos', v_photo_id, coalesce(p_display_name,'anon'),
...
begin
  ...
  insert into public.audit_logs (action, target_table, target_id, actor_name, metadata)
  values ('add_review_photo', 'review_photos', v_photo_id, coalesce(p_display_name,'anon'),
...
begin
  ...
  insert into public.audit_logs (action, target_table, target_id, actor_name, metadata)
  values ('delete_photo', p_kind||'_photos', p_photo_id, v_name,
